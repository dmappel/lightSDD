...
4. **Quality** — leftovers, debug output, dead code, changes unrelated to the spec; plus the smells that survive code written fast: shotgun surgery, feature envy, data clumps, duplicated logic, needless complexity.
